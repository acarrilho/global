...
namespace Global.Global
{
    ...
    public class MailHelper
    {
        ...
        ///<summary>
        /// Creates a new instance of the MailHelper class.
        ///</summary>
        public MailHelper()
        {
        ...
        ///<returns>The same instance of MailHelper.</returns>
        public virtual MailHelper From(string fromMail)
        {
        ...
        ///<param name="fromMail">The from mail address.</param>
        ///<returns>The same instance of MailHelper.</returns>
        public virtual MailHelper From(string fromDisplayName, string fromMail)
        {
        ...
        public virtual MailHelper To(Func<MailAddresses, MailAddresses> mailAddresses)
        {
        ...
        ///<param name="mailAddresses">The specified addresses to send to.</param>
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Cc(Func<MailAddresses, MailAddresses> mailAddresses)
        {
            foreach (var address in mailAddresses(new MailAddresses()).AddressCollection)
        ...
        ///<param name="mailAddresses">The specified addresses to send to.</param>
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Bcc(Func<MailAddresses, MailAddresses> mailAddresses)
        {
            foreach (var address in mailAddresses(new MailAddresses()).AddressCollection)
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Subject(string subject)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Body(string body)
        {
            Message.Body = body;
            return this;
        }
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper SubjectEncoding(Encoding subjectEncoding)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper BodyEncoding(Encoding bodyEncoding)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper IsBodyHtml(bool isBodyHtml)
        {
        ...
        ///<param name="host">The host from where to send the mail from.</param>
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Host(string host)
        {
        ...
        ///<param name="port">The specified port.</param>
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Port(int port)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Ssl(bool enableSsl)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Credentials(string username, string password)
        {
        ...
        ///<returns>The same instance of the mail helper class.</returns>
        public virtual MailHelper Credentials(string username, string password, string domain)
        {
